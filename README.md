About napari-elementary-numpy-operations-feedstock
==================================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/napari-elementary-numpy-operations-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15335&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/napari-elementary-numpy-operations-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `napari-elementary-numpy-operations` can be installed with `conda`:
...
```
mamba install napari-elementary-numpy-operations
```

It is possible to list all of the versions of `napari-elementary-numpy-operations` available on your platform with `conda`:
...
```
mamba search napari-elementary-numpy-operations --channel conda-forge
```
...
mamba repoquery search napari-elementary-numpy-operations --channel conda-forge

# List packages depending on `napari-elementary-numpy-operations`:
mamba repoquery whoneeds napari-elementary-numpy-operations --channel conda-forge

# List dependencies of `napari-elementary-numpy-operations`:
mamba repoquery depends napari-elementary-numpy-operations --channel conda-forge
```
